...
\begin{center}
    ...
    ID: COMETFWC052\\
    CBSE Class XII\\
    \textbf{Task--2 : IMO 2001 Problems}
\end{center}
...
\item Let $n$ be an odd integer greater than $1$ and let $k_1,k_2,\dots,k_n$ be integers.  
...
\item In triangle $ABC$, let $AP$ bisect $\angle BAC$ and $BQ$ bisect $\angle ABC$.  
Given that
\begin{equation*}
\begin{aligned}[t]
\angle BAC = 60^\circ \quad \text{and} \quad AB + BP = AQ + QB ,
\end{aligned}
\end{equation*}
